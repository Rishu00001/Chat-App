    ...
    >
      {selectedUser ? (
        <div className="flex flex-col w-full h-100vh">
          {/* Header */}
          <div className="w-full h-[80px] lg:h-[100px] bg-purple-600 lg:rounded-b-[30px] flex shadow-md px-[10px] md:px-[20px] items-center gap-[14px] lg:gap-[20px] sticky top-0 z-50">
            <div
